...
**
** Created: Thu Aug 20 12:10:43 2009
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menuT_ool = new QMenu(menuBar);
        menuT_ool->setObjectName(QString::fromUtf8("menuT_ool"));
        ...
        menuBar->addAction(menuT_ool->menuAction());
        ...
        menu_View->addAction(actionCompiled_Help_File);
        menu_View->addAction(actionHTML_Help_Message);
        menu_Test->addAction(action_Compile);
        menu_Test->addAction(actionClean);
        menu_Test->addSeparator();
        menu_Test->addAction(action_Run);
        menuT_ool->addAction(action_Option);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        menuT_ool->setTitle(QApplication::translate("MainWindow", "&Window", 0, QApplication::UnicodeUTF8));
