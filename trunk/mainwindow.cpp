...
void MainWindow::createToolBar()
{
    ...
    saveProjectAct = new QAction(QIcon(":/images/save.png"), tr("&Previous Page"),this);
    connect(saveProjectAct, SIGNAL(triggered()), this, SLOT(previousPage()));
...
void MainWindow::on_action_TreeView_Clicked_triggered(const QModelIndex &index)
{
    ...
    centerView->addTab(currentProject->getProjectPath()+"/"+parentItem->objectUrl().toString());

//    QFile file(currentProject->getProjectPath()+"/"+parentItem->objectUrl().toString());
//    QTextStream stream(&file);
//
//    QTextEdit* tabEditor = (QTextEdit*)centerView->currentWidget();
//
////    QTextEdit* editor = (QTextEdit*)tabEditor->currentWidget();
//    tabEditor->setText(stream.readAll());
    //QMessageBox::about(0,QString("URL"),currentProject->getProjectPath()+"/"+parentItem->objectUrl().toString());
}
