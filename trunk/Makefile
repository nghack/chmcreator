...
# Generated by qmake (2.01a) (Qt 4.4.2) on: ??? ?? 20 08:20:07 2009
# Project:  chmcreator.pro
# Template: app
# Command: e:\qt\bin\qmake.exe -spec ..\..\qt\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile chmcreator.pro
#############################################################################
...
Makefile: chmcreator.pro  ../../qt/mkspecs/win32-g++/qmake.conf ../../qt/mkspecs/qconfig.pri \
		...
		e:/qt/lib/qtmain.prl
	$(QMAKE) -spec ..\..\qt\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile chmcreator.pro
