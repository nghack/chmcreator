...
# Generated by qmake (2.01a) (Qt 4.4.2) on: ??? ?? 22 07:28:57 2009
# Project:  chmcreator.pro
# Template: app
# Command: e:\qt\bin\qmake.exe -spec e:\qt\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile chmcreator.pro
#############################################################################
...
Makefile: chmcreator.pro  e:/qt/mkspecs/win32-g++/qmake.conf e:/qt/mkspecs/qconfig.pri \
		...
		e:/qt/lib/qtmain.prl
	$(QMAKE) -spec e:\qt\mkspecs\win32-g++ -win32 CONFIG+=release -o Makefile chmcreator.pro
